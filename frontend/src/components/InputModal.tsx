...
export default function InputModal({ error, onStart }: Props) {
  ...
  return (
    ...
    >
      <Box bg="white" p={10} borderRadius="16px" minW="560px" boxShadow="0 24px 60px rgba(0,0,0,0.18)">
        {/* Heading */}
        <Text
          mb={2}
          fontSize="28px"
        ...
        {/* Subtext */}
        <Text mb={7} fontSize="15px" color="gray.500" lineHeight="1.6">
        ...
        <Box display="flex" gap={2}>
          <input
            ...
            placeholder="Enter your Goodreads user ID or profile URL"
          />
          <button
            style={{
              padding: "10px 22px",
